...
@Entity
@Table(name = "sp_tcdr_detailed_requirement")
public class DetailedRequirement extends AbstractModel{
	...
	@Column(name="who_defines_detailed")
	private String whoDefinesDetailed;
	...
	public String getWhoDefinesDetailed() {
		return whoDefinesDetailed;
	}

	public void setWhoDefinesDetailed(String whoDefinesDetailed) {
		this.whoDefinesDetailed = whoDefinesDetailed;
	}
