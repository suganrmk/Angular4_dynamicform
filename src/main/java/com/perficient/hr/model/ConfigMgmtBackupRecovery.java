...
@Entity
@Table(name = "sp_cm_backup_and_recovery_plan")
@SuppressWarnings("serial")
public class ConfigMgmtBackupRecovery extends AbstractModel {
	...
	@Column(name = "backup_and_recovery_plan")
	...
	public String getBackupRecovery() {
		return backupRecovery;
	}

	public void setBackupRecovery(String backupRecovery) {
		this.backupRecovery = backupRecovery;
	}
