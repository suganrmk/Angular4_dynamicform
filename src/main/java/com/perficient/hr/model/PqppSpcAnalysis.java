...
@Entity
@Table(name = "sp_pqpp_spc_analysis")
@SuppressWarnings("serial")
public class PqppSpcAnalysis extends AbstractModel {
	...
	@Column(name = "spc_analysis")
	private String spcAnalysis;
	...
	public String getSpcAnalysis() {
		return spcAnalysis;
	}

	public void setSpcAnalysis(String spcAnalysis) {
		this.spcAnalysis = spcAnalysis;
	}
